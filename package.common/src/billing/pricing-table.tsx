...
const tiers = [
  ...
  // },
  {
    ...
    id: 'premium',
    badge: 'Popular',
    description: 'For Starters & SMEs',
    priceMonthly: '800',
    billingPeriod: 'per service',
    highlights: [
      { description: 'Custom domains', icon: GlobeAltIcon },
      { description: 'Web Presence', icon: SignalIcon },
      { description: 'Webshop / E-Commerce', icon: ShoppingCartIcon },
      { description: 'Hosting & Database', icon: CircleStackIcon },
      { description: 'AI & Automation', icon: CpuChipIcon },
      { description: 'Support & Maintenance', icon: LifebuoyIcon },
    ],
  },
  {
    name: 'Enterprise',
    id: 'team',
    description: 'For enterprise level customers',
    priceMonthly: '2900',
    billingPeriod: 'per month',
    highlights: [
      { description: 'All Premium features', icon: ArrowUpIcon },
      { description: 'Custom AI models', icon: BeakerIcon },
      { description: 'Advanced marketing tools', icon: MegaphoneIcon },
      {
        description: 'White-label solutions',
        icon: TagIcon,
      },
      { description: 'Dedicated server or private cloud', icon: CloudIcon },
    ],
  },
];
